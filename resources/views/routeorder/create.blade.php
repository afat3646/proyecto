...
<body class="bg-dark text-white">
    ...
    <main class="container mt-5">
        ...
        <form action="{{ route('routeOrder.store') }}" method="POST" class="p-4 bg-dark text-white border rounded">
            @csrf


            <div class="mb-3">
                <label for="order_id" class="form-label">Select Order</label>
                <select name="order_id" id="order_id" class="form-control bg-dark text-white" required>
